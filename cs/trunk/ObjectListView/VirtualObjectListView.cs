...
namespace BrightIdeasSoftware
{
    ...
    public class VirtualObjectListView : ObjectListView
    {
        ...
        protected new virtual int VirtualListSize
        {
            ...
            set
            {
                ...
                if (virtualListSizeFieldInfo == null)
                {
                    ...
                    // we must use the private field here, instead of the VirtualListSize property, otherwise the property setter is called with SetValue, which defeats the purpose
                    if (virtualListSizeFieldInfo == null)
        ...
        /// </summary>
        /// <param name="index">The index where the new objects will be inserted</param>
        /// <param name="modelObjects">A collection of model objects</param>
        /// <remarks>
        /// <para>The added objects will appear in their correct sort position, if sorting
